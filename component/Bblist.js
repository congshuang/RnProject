...
class Bblist extends Component{
  ...
  render(){
    return(
      <View style={styles.container}>
          <View style={styles.top}><Text style={styles.title}>报表</Text></View>
  ...
  componentDidMount(){
    let ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});
    let data = [
        {url:"",title:"发文情况统计",img:require('../state/fwqktj.png')},
        {url:"",title:"人员统计",img:require('../state/rytj.png')},
        {url:"",title:"项目字段类型",img:require('../state/xmzdlx.png')},
        {url:"",title:"项目管理",img:require('../state/xmgl.png')},
