...
class Gzlist extends Component{
  constructor(props){
    super(props);
  ...
  render(){
    return(
      <View style={styles.container}>
          <View style={styles.top}><Text style={styles.title}>工作</Text></View>
  ...
  componentDidMount(){
    let ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});
    let data = [
        {url:"",title:"日报",img:require('../state/rb.png')},
        {url:"",title:"任务",img:require('../state/rw.png')},
