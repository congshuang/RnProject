...
class TxlList extends Component{
  constructor(props){
    super(props);
  ...
  render(){
    return(
      <View style={styles.container}>
          <View style={styles.top}><Text style={styles.title}>通讯录</Text></View>
  ...
  componentDidMount(){
    let ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});
    let data = [
        {url:"",title:"职员",img:require('../state/zy.png')},
        {url:"",title:"客户",img:require('../state/kh.png')},
        {url:"",title:"供应商",img:require('../state/gys.png')},
        {url:"",title:"群组",img:require('../state/qz.png')},
