...
class Wdlist extends Component{
  constructor(props){
    super(props);
  ...
  render(){
    return(
      <View style={styles.container}>
          <View style={styles.top}><Text style={styles.title}>文档</Text></View>
  ...
  componentDidMount(){
    let ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});
    let data = [
        {url:"",title:"智慧城市项目",img:require('../state/zhcsxm.png')},
        {url:"",title:"文档管理",img:require('../state/wdgl.png')},
